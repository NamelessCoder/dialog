#
# Table structure for table 'tx_dialog_domain_model_discussion'
#
CREATE TABLE tx_dialog_domain_model_discussion (
...
#
# Table structure for table 'tx_dialog_domain_model_thread'
#
CREATE TABLE tx_dialog_domain_model_thread (
	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_dialog_domain_model_post'
#
CREATE TABLE tx_dialog_domain_model_post (
	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_dialog_domain_model_poster'
#
CREATE TABLE tx_dialog_domain_model_poster (
	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,
